...
parser_cfg.add_argument('--camera', dest='camera', default=DEF_CAMERA_ID, help='camera id')
...
PEOPLE_COUNT_LEFT_BORDER = 250
PEOPLE_COUNT_RIGHT_BORDER = 390
